...
public class XMLRequests {
	public static String getFoodGroupsXML()
	{
	...
	public static String getFoodsInGroupXML(int groupId) {
		return "<?xml version=\"1.0\" encoding=\"utf-8\"?>"
		     + "	<foodquery>"
			   + "<type level=\"1\"/>"
		       + "<selection>"
			   ...
			   + "<condition>"
		         ...
		         + "</cond1>"
			     + "<relation type=\"EQUAL\"/>"
		         + "	<cond3>" + (new Integer(groupId)).toString() + "</cond3>"
			   + "</condition>"
		       + "<condition>"
			     + "<cond1>"
	...
	public static String getFoodXML(int foodId) {
		return "<?xml version=\"1.0\" encoding=\"utf-8\"?>"
	         + "<foodquery>"
			   + "<type level=\"2\"/>"
	           + "<selection>"
			   ...
			   + "<condition>"
	             ...
	             + "</cond1>"
			     + "<relation type=\"EQUAL\"/>"
	             + "<cond3>" + (new Integer(foodId)).toString() + "</cond3>"
			   + "</condition>"
	           + "<condition>"
			     + "<cond1>"
